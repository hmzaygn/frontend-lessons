...
declare type RelativeFilterOption = 'w' | 't' | 'm' | 'y' | null;
...
declare const DonutChart: ({ data, category, dataKey, colors, valueFormatter, label, showLabel, showAnimation, showTooltip, height, marginTop, }: DonutChartProps) => JSX.Element;
...
declare const Tab: ({ value, text, icon, privateProps, }: TabProps) => JSX.Element;
...
declare const Button: ({ text, icon, iconPosition, handleClick, size, color, importance, marginTop, disabled }: ButtonProps) => JSX.Element;
...
declare const ButtonInline: ({ text, icon, iconPosition, handleClick, size, color, marginTop, disabled }: ButtonInlineProps) => JSX.Element;
...
declare const Datepicker: ({ handleSelect, enableRelativeDates, defaultRelativeFilterOption, defaultStartDate, defaultEndDate, minDate, maxDate, placeholder, color, marginTop, maxWidth, }: DatepickerProps) => JSX.Element;
